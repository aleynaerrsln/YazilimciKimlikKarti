...
const DEVELOPERS: Developer[] = [
  { id: 1, ad: 'Aleyna Arslan', uzmanlik: 'Mobile Developer', seviye: 'Junior', avatar: '👩‍💻', renk: ['#e94560', '#0f3460'], teknolojiler: ['React Native', 'TypeScript', 'Expo'], bio: 'Mobil uygulama geliştirmeye tutkulu, yeni teknolojileri keşfetmeyi seviyor.', deneyim: '1 yıl', proje: 4, maas: 45000, rating: 4.2, skills: [{ name: 'React Native', level: 75 }, { name: 'TypeScript', level: 60 }, { name: 'UI/UX', level: 50 }] },
